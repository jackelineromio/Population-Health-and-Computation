...
ggplot(data = weekly, aes(x=weeks, y=avg_daily, col=Country))+geom_line()+geom_point()+ylab("Casos semanales confirmados")+theme_minimal()
```
...
ggplot(data = weekly, aes(x=weeks, y=avg_daily, col=Country))+geom_line()+geom_point()+ylab("Muertes semanales")+theme_minimal()
```
